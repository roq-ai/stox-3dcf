...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Alerts', path: '/alerts', entity: 'alert', service: AccessServiceEnum.PROJECT, icon: FiBell },
    {
      name: 'Dashboards',
      path: '/dashboards',
      entity: 'dashboard',
    ...
    { name: 'Scanners', path: '/scanners', entity: 'scanner', service: AccessServiceEnum.PROJECT, icon: FiSearch },
