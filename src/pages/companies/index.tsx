...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'dashboard.count', 'equity_stock.count', 'scanner.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('dashboard', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('equity_stock', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'equity_stock',
          header: 'Equity Stock',
          accessorKey: 'equity_stock',
          cell: ({ row: { original: record } }: any) => record?._count?.equity_stock,
        }
      : null,
    hasAccess('scanner', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'scanner',
          header: 'Scanner',
          accessorKey: 'scanner',
          cell: ({ row: { original: record } }: any) => record?._count?.scanner,
        }
      : null,
