...
import { getEquityStockById } from 'apiSdk/equity-stocks';
import { EquityStockInterface } from 'interfaces/equity-stock';

function EquityStockViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('equity_stock', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/equity-stocks/edit/${id}`} passHref legacyBehavior>
                    <Button
